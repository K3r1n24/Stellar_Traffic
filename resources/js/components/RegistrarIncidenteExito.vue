            ...
            <div class="success-view">
                ...
                <div class="success-card">
                    ...
                    <div class="card-actions">
                        <button class="btn btn-outline" @click="viewReport">Ver reporte completo</button>
                        <button class="btn btn-outline" @click="goHome">Volver al inicio</button>
                    </div>
                ...
                <div class="bottom-action-area">
                    <button class="btn btn-primary" @click="newIncident">
                        <i class="ph ph-plus-square"></i> Registrar nuevo incidente
                    </button>
                </div>
...
<style scoped>
    ...
    /* --- VISTA DE ÉXITO --- */
    .success-view { flex: 1; display: flex; flex-direction: column; justify-content: space-between; align-items: center; width: 100%; max-width: 1000px; margin: 0 auto; padding-top: 20px; }
    ...
    .success-card h2 { font-size: 24px; font-weight: 600; margin: 0 0 10px 0; }
    .success-card p { font-size: 14px; color: var(--text-muted); margin: 0; }
    ...
    .report-label { font-size: 11px; color: var(--text-muted); letter-spacing: 1px; margin-bottom: 10px; display: block; }
    .report-value { font-size: 28px; font-weight: 700; color: var(--accent-blue); }

    /* Botones dentro de la tarjeta */
    .card-actions { display: flex; gap: 20px; justify-content: center; }
    .btn { padding: 14px 30px; border-radius: 10px; font-size: 14px; font-weight: 500; cursor: pointer; transition: 0.2s; display: flex; align-items: center; gap: 8px; }
    .btn-outline { background-color: transparent; border: 1px solid var(--border-color); color: var(--text-main); }
    .btn-outline:hover { background-color: rgba(255, 255, 255, 0.05); border-color: #3b4c6b; }
    
    /* Botón Inferior Principal */
    .bottom-action-area { margin-top: 40px; margin-bottom: 20px; }
    .btn-primary { background-color: var(--primary-blue); border: 1px solid var(--primary-blue); color: white; padding: 14px 40px; }
    .btn-primary:hover { background-color: var(--accent-blue); }

    /* Responsividad */
    @media (max-width: 768px) {
        .report-id-section { width: 100%; }
