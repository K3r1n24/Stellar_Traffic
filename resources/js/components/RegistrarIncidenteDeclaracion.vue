                ...
                <div class="details-card">
                    ...
                    <div class="section-header">
                        ...
                        <div class="section-header-text">
                            ...
                            <p>Proporciona información adicional sobre lo ocurrido.</p>
                        </div>
                    </div>
...
const handleNext = () => {
    ...
    // Redirigir a la siguiente pantalla cuando exista
    // router.push({ name: 'registrar-incidente-paso-4' });
    alert("Datos guardados correctamente. ¡Listo para avanzar al Paso 4!");
};
...
<style scoped>
    ...
    .details-card { border: 1px solid var(--accent-blue); border-radius: 16px; padding: 40px 50px; background-color: transparent; margin-bottom: 30px; display: flex; flex-direction: column; gap: 30px;}
