        ...
        <main class="content">
            ...
            <section class="panel" aria-labelledby="panel-title">
                ...
                >
                    ...
                    >
                        <div
                            class="choice-card__art"
                            :class="option.artClass"
                            aria-hidden="true"
                        >
                            <span class="choice-card__emoji">{{
                                option.emoji
                            }}</span>
                        </div>
