...
files.forEach(file => {
    ...
    // Remove handleLogout and goTo and activeNav logic if it exists since it's moved to Sidebar
    // Actually we can leave them, they are harmless, but let's just write back the content
    if (modified) {
